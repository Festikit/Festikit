...
if (empty($tab_candidature)) {
    ...
    foreach ($tab_candidature as $c) {
        ...
        echo " $i : <a href=\"index.php?action=accepterUtilisateur&controller=festival&user_id=" . rawurlencode($c->getId()) . "&festival_id=" . rawurlencode($f->getFestivalId()) . "\" target=\"target\" > Accepter </a></p>";
        $i++;
    }
}
